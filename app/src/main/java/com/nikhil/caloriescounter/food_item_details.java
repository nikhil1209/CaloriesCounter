...
public class food_item_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alert=new AlertDialog.Builder(food_item_details.this);
                ...
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        startActivity(new Intent(food_item_details.this,display_food_activity.class));

                        //remove this activity from activity stack
                        food_item_details.this.finish();
    ...
    public void shareCalc(){
        ...
        dataString.append(" Calorie: "+cals+"\n");
        ...
        try{
            ...
            Toast.makeText(getApplicationContext(),"Please install email client beffore sending",
